...
# this script creates 4day forward trajectories initialized at +48h wrt the date of the forecast along 70N for 120 equally spaced dots (delta lon = 3deg)

#Arguments for this script to work are following:
#forecast date (given as 'YYYYmmdd_hh')
#(here startdate for the fw trajectories (given as 'YYYYmmdd_hh') at +48h)
#E.g., ./runLat70N_48h.sh 20200417_00
...
# -------------------------------------------------------
forecastdate=$1
startdate=`newtime ${forecastdate} 48`
dur_h=96
...
TRAJFILE=traj_ARTofMELT_forecast_${forecastdate}_70Nlatband_48h_4dfw
